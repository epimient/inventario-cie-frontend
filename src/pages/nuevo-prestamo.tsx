    ...
    return (
        <div className="space-y-8 animate-fade-in pb-8">
            ...
            <nav className="flex items-center gap-2 text-sm text-muted-foreground">
                <Link to="/prestamos" className="hover:text-[#4f645b]">Préstamos</Link>
                <span className="text-xs">›</span>
                <span className="font-semibold text-[#4f645b]">Nuevo Préstamo</span>
            </nav>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2">
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100/50">
                        <h2 className="text-2xl font-bold text-[#2d3335] mb-2">Nuevo Préstamo</h2>
                        <p className="text-[#5a6062] text-sm mb-8">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                <label className="block text-sm font-semibold text-[#2d3335] ml-1">Prestatario</label>
                                <div className="relative">
                                    ...
                                    <select
                                        ...
                                        className="w-full h-14 pl-12 pr-4 bg-[#f1f4f5] border-none rounded-xl focus:ring-2 focus:ring-[#4f645b]/20 text-sm font-medium appearance-none"
                                        required
                                    >
                                ...
                                <p className="text-[11px] text-muted-foreground px-1 italic">El usuario debe estar activo en el sistema.</p>
                            </div>

                            {/* Tipo de Item */}
                            <div className="space-y-2">
                                <label className="block text-sm font-semibold text-[#2d3335] ml-1">Tipo de Item</label>
                                <div className="relative">
                                    <div className="absolute left-4 top-1/2 -translate-y-1/2 text-muted-foreground">
                            ...
                            {/* Item */}
                            <div className="space-y-2">
                                <label className="block text-sm font-semibold text-[#2d3335] ml-1">Item</label>
                                <div className="relative">
                                    <div className="absolute left-4 top-1/2 -translate-y-1/2 text-muted-foreground">
                                        <Package className="w-5 h-5" />
                                    </div>
                                ...
                                <p className="text-[11px] text-muted-foreground px-1 italic">Solo se listan items con estado "Disponible".</p>
                            </div>

                            {/* Fecha Límite */}
                            <div className="space-y-2">
                                <label className="block text-sm font-semibold text-[#2d3335] ml-1">Fecha Límite</label>
                                <div className="relative">
                                    <div className="absolute left-4 top-1/2 -translate-y-1/2 text-muted-foreground">
                                    ...
                                    <input
                                        ...
                                        className="w-full h-14 pl-12 pr-4 bg-[#f1f4f5] border-none rounded-xl focus:ring-2 focus:ring-[#4f645b]/20 text-sm font-medium"
                                        required
                                    />
                                </div>
                            ...
                            {/* Observaciones */}
                            <div className="space-y-2">
                                <label className="block text-sm font-semibold text-[#2d3335] ml-1">Observaciones</label>
                                <textarea
                                    value={form.observaciones}
                                    onChange={(e) => setForm({ ...form, observaciones: e.target.value })}
                                    placeholder="Detalles adicionales sobre el préstamo, estado inicial del equipo, o propósitos específicos..."
                                    className="w-full p-4 bg-[#f1f4f5] border-none rounded-xl focus:ring-2 focus:ring-[#4f645b]/20 text-sm font-medium resize-none"
                                    rows={4}
                                />
                            </div>
                            ...
                            <div className="pt-6 flex items-center justify-end gap-4 border-t border-gray-100">
                                <Link to="/prestamos">
                                    <Button type="button" variant="ghost" className="px-8 py-3 rounded-full">
                                        Cancelar
                                    </Button>
                                </Link>
                                <Button 
                                    type="submit" 
                                    disabled={isCreating}
                                    className="px-10 py-3 bg-gradient-to-br from-[#4f645b] to-[#43574f] text-white rounded-full font-bold shadow-lg shadow-[#4f645b]/20 hover:scale-[1.02] active:scale-95 transition-all flex items-center gap-2"
                                >
                ...
                <div className="space-y-4">
                    <div className="bg-[#cae6fe] p-5 rounded-xl">
                        <h4 className="text-[#274255] font-bold text-xs uppercase tracking-widest mb-2">Préstamos Activos</h4>
                        <div className="flex items-end justify-between">
                            <span className="text-2xl font-black text-[#274255]">{equiposDisponibles.length}</span>
                            <History className="h-6 w-6 text-[#274255]/30" />
                        </div>
                    </div>
                    <div className="bg-[#f1f4f5] p-5 rounded-xl">
                        <h4 className="text-muted-foreground font-bold text-xs uppercase tracking-widest mb-2">Devoluciones Hoy</h4>
                        <div className="flex items-end justify-between">
                            <span className="text-2xl font-black text-[#2d3335]">0</span>
                            <History className="h-6 w-6 text-muted-foreground/30" />
                        </div>
                    </div>
                    <div className="bg-red-50 p-5 rounded-xl">
                        <h4 className="text-red-600 font-bold text-xs uppercase tracking-widest mb-2">Vencidos</h4>
                        <div className="flex items-end justify-between">
                            <span className="text-2xl font-black text-red-600">0</span>
                            <AlertTriangle className="h-6 w-6 text-red-600/30" />
                        </div>
                    </div>
                </div>
            </div>
