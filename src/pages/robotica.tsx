        ...
        <div className="space-y-6 animate-fade-in pb-8">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div className="space-y-2">
                    <h2 className="text-4xl font-extrabold text-[#2d3335] tracking-tighter leading-none">Robótica</h2>
                    <p className="text-[#5a6062] max-w-md">Gestiona y monitorea el estado de todos los robots y componentes de robótica.</p>
                </div>
